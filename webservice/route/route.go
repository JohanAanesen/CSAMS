...
func routes() http.Handler {
	...
	router.HandleFunc("/assignment/submission/{id:[0-9]+}/withdraw", controller.AssignmentWithdrawGET).Methods("GET")
	...
	adminrouter.HandleFunc("/assignment/submission/delete", controller.AdminAssignmentSubmissionDELETE).Methods("DELETE")
