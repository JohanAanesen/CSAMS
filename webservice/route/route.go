...
func routes() http.Handler {
	...
	userrouter.HandleFunc("/assignment/{id:[0-9]+}/submission/{userid:[0-9]+}/message", controller.AssignmentUserSubmissionMessagePOST).Methods("POST")
	...
	adminrouter.HandleFunc("/assignment/{id:[0-9]+}/report.xlsx", controller.AdminAssignmentGetReportGET).Methods("GET")
