...
(6, 2, 'checkbox', 'lab_1_cloud_2019_4', 'Is the duration fomratted in ISO 20915092835209 ?', 'GET /api', 0, 4, 1, ''),
(7, 2, 'checkbox', 'lab_1_cloud_2019_5', 'Does it work?', 'GET /api/foo', 0, 5, 1, ''),
(8, 2, 'checkbox', 'lab_1_cloud_2019_6', 'Does it work?', 'POST /api/foo', 0, 6, 1, '');
